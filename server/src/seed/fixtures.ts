...
const BUSINESS_GENERIC = [...MUDRA, 'CGTMSE-CREDIT', 'MICRO-CREDIT', 'PMEGP', 'PM-VISHWAKARMA'];
const SOCIAL_CORP = ['NBCFDC-TL', 'NMDFC-TL', 'NHFDC-TL', 'STANDUP-INDIA', 'PMEGP', 'PM-VISHWAKARMA', 'ANNAPURNA', 'MAHILA-UDYAM'];
const EDUCATION = ['EDU-SKILL', 'EDU-VIDYALAKSHMI', 'SKILL-LOAN'];
const RURAL_LIVELIHOOD = ['KCC', 'DAIRY-ENTRE', 'DAY-NRLM', 'PMMY-SHISHU', 'PMMY-KISHOR'];
const URBAN_LIVELIHOOD = ['DAY-NULM-SEP', 'PM-SVANIDHI', 'PMMY-SHISHU', 'PMMY-KISHOR', 'MICRO-CREDIT'];
