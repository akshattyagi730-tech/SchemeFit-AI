...
export const centralSchemes = [
  ...
  },
  {
    ...
    eligibility: { genders: ['female'], minAge: 19, maxAge: 45 },
  ...
  // ── Startup ─────────────────────────────────────────────────────────────
  {
    ...
    description: 'Up to ₹20 lakh as a grant for proof of concept, and up to ₹50 lakh as debt/convertible for commercialisation, for DPIIT-recognised startups incorporated not more than 2 years ago. Needs a registered startup and a project plan. Demonstration figures only.',
    eligibility: { minAge: 18, maxAge: 64, occupations: ['self_employed', 'unemployed', 'private_salaried'], requiresBusinessPlan: true },
